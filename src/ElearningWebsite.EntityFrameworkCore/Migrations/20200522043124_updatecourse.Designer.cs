...
namespace ElearningWebsite.Migrations
{
    ...
    [Migration("20200522043124_updatecourse")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElearningWebsite.Entities.Course", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ElearningWebsite.Entities.CourseType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ElearningWebsite.Entities.Lesson", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ElearningWebsite.Entities.StudentCourse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ElearningWebsite.Entities.TypeOfCourse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ElearningWebsite.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ElearningWebsite.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ElearningWebsite.Entities.Course", b =>
                {
                    b.HasOne("ElearningWebsite.Authorization.Users.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("ElearningWebsite.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ElearningWebsite.Entities.Lesson", b =>
                {
                    b.HasOne("ElearningWebsite.Entities.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("ElearningWebsite.Entities.TypeOfCourse", b =>
                {
                    ...
                    b.HasOne("ElearningWebsite.Entities.CourseType", "CourseType")
                        .WithMany()
